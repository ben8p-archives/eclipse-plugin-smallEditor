...
public interface IConstants {
	public final String CONTENT_TYPE_JS = "smallEditor.contentype.javascript";
	public final String CONTENT_TYPE_CSS = "smallEditor.contentype.css";
	public final String CONTENT_TYPE_LESS = "smallEditor.contentype.less";
	public final String CONTENT_TYPE_HTML = "smallEditor.contentype.html";

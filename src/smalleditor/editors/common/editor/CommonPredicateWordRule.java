 ...
 * @author fitzpata
 */
public class CommonPredicateWordRule extends WordRule implements IPredicateRule {
	...
	public CommonPredicateWordRule(IWordDetector detector) {
		super(detector);
	}
	 ...
	 * @see #addWord
	 */
	public CommonPredicateWordRule(IWordDetector detector, IToken defaultToken) {
		super(detector, defaultToken);
	}

	public CommonPredicateWordRule(IWordDetector detector, String tokenString,
			IToken tokenType) {
		super(detector);
		this.addWord(tokenString, tokenType);
	}

	public CommonPredicateWordRule(IWordDetector detector, String[] tokens,
			IToken tokenType) {
		super(detector);
	...
	public CommonPredicateWordRule(IWordDetector detector, IToken defaultToken,
			String[] tokens, IToken tokenType) {
		super(detector, defaultToken);
		this.addWords(tokens, tokenType);
	}

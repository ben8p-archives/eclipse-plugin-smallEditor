...
public class FoldingActionsGroup extends ActionGroup {
	...
	public FoldingActionsGroup(ITextEditor textEditor) {
		...
		collapseAction = new TextOperationAction(
		...
		collapseAllAction = new TextOperationAction(
				Messages.getResourceBundle(),
		...
		textEditor.setAction(IFoldingCommandIds.FOLDING_COLLAPSE_ALL,
				collapseAllAction);

		expandAllAction = new TextOperationAction(
				Messages.getResourceBundle(),
		...
		textEditor.setAction(IFoldingCommandIds.FOLDING_EXPAND_ALL,
				expandAllAction);
	}

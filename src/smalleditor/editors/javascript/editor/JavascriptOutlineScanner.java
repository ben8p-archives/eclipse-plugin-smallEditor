 ...
 *
 */
public class JavascriptOutlineScanner extends BufferedRuleBasedScanner {
	 ...
	 */
	public JavascriptOutlineScanner() {
		...
		rules.add(new WordRule(new CommonWordDetector(), TOKEN_DEFAULT));

 ...
 */
public class CssLinter extends CommonLinter {
	private static final String DEFAULT_LINTER = "res/linter/cssparser.js";
	...
	protected Function findLinterFunction(ScriptableObject scope)
		...
		Object object;
		if (ScriptableObject.hasProperty(scope, "cssparser")) {
			object =  scope.get("cssparser", scope);
			object = NativeObject.getProperty((NativeObject) object, "parse");
		} else {
			throw new IllegalArgumentException(
					"cssparser function missing in input");
		}

		if (!(object instanceof Function)) {
			throw new IllegalArgumentException(
					"cssparser is not a function");
		}
	...
	protected BufferedReader getLinterReader()
		...
		ClassLoader classLoader = CssLinter.class.getClassLoader();
	...
	public void main(String[] args) {
		CssLinterRunner runner = new CssLinterRunner();
		runner.run(args);
	}
